...
public class SocialUtils {
    ...
    public static AuthResponse<AuthUser> loginAuth(String source, String socialCode, String socialState, SocialProperties socialProperties) throws AuthException {
