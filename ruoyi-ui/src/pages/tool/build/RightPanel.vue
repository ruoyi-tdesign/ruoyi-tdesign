<template>
  <div class="right-board">
    ...
    <tree-node-dialog v-model:visible="dialogVisible" title="添加选项" @commit="addNode" />
...
import { inputComponents, layoutComponents, selectComponents } from '@/utils/generator/config';
