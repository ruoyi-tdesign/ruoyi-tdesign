...
INSERT INTO sys_menu VALUES ('11616', '工作流', '0', '6', 'workflow', '', '', '', '0', '1', 'M', '1', '1', '', 'tree-round-dot-vertical', null, '!getProperty(''warm-flow.enabled'')', 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11618', '我的任务', '0', '7', 'task', '', '', '', '0', '1', 'M', '1', '1', '', 'task', null, '!getProperty(''warm-flow.enabled'')', 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11619', '我的待办', '11618', '2', 'taskWaiting', 'workflow/task/taskWaiting', '', '', '0', '0', 'C', '1', '1', '', 'task-visible', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11632', '我的已办', '11618', '3', 'taskFinish', 'workflow/task/taskFinish', '', '', '0', '0', 'C', '1', '1', '', 'task-checked', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11633', '我的抄送', '11618', '4', 'taskCopyList', 'workflow/task/taskCopyList', '', '', '0', '0', 'C', '1', '1', '', 'user-arrow-left', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11620', '流程定义', '11616', '3', 'processDefinition', 'workflow/processDefinition/index', '', '', '0', '0', 'C', '1', '1', '', 'system-components', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11621', '流程实例', '11630', '1', 'processInstance', 'workflow/processInstance/index', '', '', '0', '0', 'C', '1', '1', '', 'tree-round-dot', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11622', '流程分类', '11616', '1', 'category', 'workflow/category/index', '', '', '0', '1', 'C', '1', '1', 'workflow:category:list', 'app', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11629', '我发起的', '11618', '1', 'myDocument', 'workflow/task/myDocument', '', '', '0', '0', 'C', '1', '1', '', 'send', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11630', '流程监控', '11616', '4', 'monitor', '', '', '', '0', '1', 'M', '1', '1', '', 'chart-analytics', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11631', '待办任务', '11630', '2', 'allTaskWaiting', 'workflow/task/allTaskWaiting', '', '', '0', '0', 'C', '1', '1', '', 'task-visible', null, null, 103, 1, now(), NULL, NULL, '');

INSERT INTO sys_menu VALUES ('11623', '流程分类查询', '11622', '1', '#', '', '', '', '0', '1', 'F', '1', '1', 'workflow:category:query', '#', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11624', '流程分类新增', '11622', '2', '#', '', '', '', '0', '1', 'F', '1', '1', 'workflow:category:add', '#', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11625', '流程分类修改', '11622', '3', '#', '', '', '', '0', '1', 'F', '1', '1', 'workflow:category:edit', '#', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11626', '流程分类删除', '11622', '4', '#', '', '', '', '0', '1', 'F', '1', '1', 'workflow:category:remove', '#', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11627', '流程分类导出', '11622', '5', '#', '', '', '', '0', '1', 'F', '1', '1', 'workflow:category:export', '#', null, null, 103, 1, now(), NULL, NULL, '');

INSERT INTO sys_menu VALUES ('11801', '流程表达式', '11616', '2', 'spel',    'workflow/spel/index', '', '', '0', '1', 'C', '1', '1', 'workflow:spel:list', 'input', null, null, 103, 1, now(), 1, now(), '流程达式定义菜单');
...
INSERT INTO sys_menu VALUES ('11638', '请假申请', '11618', '1', 'leave', 'workflow/leave/index', '', '', '0', '1', 'C', '1', '1', 'workflow:leave:list', '#', null, null, 103, 1, now(), NULL, NULL, '请假申请菜单');
INSERT INTO sys_menu VALUES ('11639', '请假申请查询', '11638', '1', '#', '', '', '', '0', '1', 'F', '1', '1', 'workflow:leave:query', '#', null, null, 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('11640', '请假申请新增', '11638', '2', '#', '', '', '', '0', '1', 'F', '1', '1', 'workflow:leave:add', '#', null, null, 103, 1, now(), NULL, NULL, '');
