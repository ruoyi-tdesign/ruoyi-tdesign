...
public class SysClientController extends BaseController {
    ...
    @GetMapping("/list")
    public TableDataInfo<SysClientVo> list(SysClientQuery query) {
        return sysClientService.queryPageList(query);
    }
    ...
    @PostMapping("/export")
    public void export(SysClientQuery query, HttpServletResponse response) {
        List<SysClientVo> list = sysClientService.queryList(query);
     ...
     * @param id 主键
     */
    @SaCheckPermission(value = {"system:client:query", "system:client:edit"}, mode = SaMode.OR)
    @GetMapping("/{id}")
